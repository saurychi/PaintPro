...
const btnNeutral =
  `${btnBase} border border-gray-200 bg-white px-4 py-2 text-gray-700 hover:bg-gray-50 hover:shadow-md`
const btnDanger =
...
export default function ClientSettings() {
  ...
  const handleLogout = async () => {
    try {
      // Clear the httpOnly server cookie via the DELETE endpoint
